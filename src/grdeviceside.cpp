    ...
    namespace grdevices {
        namespace ide {
            ...
            private:
                ...
                boost::filesystem::path _snapshot_render_filename;
            ...
            public:
                ...
                boost::filesystem::path save();
                void send(const boost::filesystem::path& filename);
            ...
            private:
                boost::filesystem::path get_render_file_path();
                pDevDesc get_or_create_file_device();
                pDevDesc create_file_device();
                void sync_file_device();
                void set_pending_render();

                static pDevDesc create_file_device(const std::string& device_type, const boost::filesystem::path& filename, double width, double height);
            ...
            private:
                ...
                boost::filesystem::path _file_device_filename;
            ...
            plot::~plot() {
                if (!_snapshot_render_filename.empty()) {
                    try {
                        boost::filesystem::remove(_snapshot_render_filename);
            ...
            boost::filesystem::path ide_device::save() {
            ...
            void ide_device::send(const boost::filesystem::path& filename) {
            ...
            boost::filesystem::path ide_device::get_render_file_path() {
            ...
            void ide_device::output_and_kill_file_device() {
                ...
                _file_device = nullptr;
                _file_device_filename = boost::filesystem::path();
            }
            ...
            pDevDesc ide_device::create_file_device(const std::string& device_type, const boost::filesystem::path& filename, double width, double height) {
