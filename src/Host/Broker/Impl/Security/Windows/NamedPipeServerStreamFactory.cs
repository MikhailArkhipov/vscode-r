...
namespace Microsoft.R.Host.Broker.Security.Windows {
    public class NamedPipeServerStreamFactory : IUserProfileNamedPipeFactory {
        ...
        public NamedPipeServerStream CreatePipe(string name, int maxInstances) {
            ...
            var pipe = new NamedPipeServerStream(name, PipeDirection.InOut, maxInstances, PipeTransmissionMode.Byte, PipeOptions.Asynchronous, 1024, 1024);
