...
namespace rhost {
    namespace grdevices {
        ...
        void* devdesc_wrapper::allocate() {
            ...
            switch (ver) {
            case 10: return calloc(1, sizeof(DevDesc10));
            case 11: return calloc(1, sizeof(DevDesc11));
            case 12: return calloc(1, sizeof(DevDesc12));
            default: RHOST_DEV_VERSION_ASSERT(ver); return nullptr;
            }
        }

        devdesc_wrapper::operator pDevDesc() {
            switch (_ver) {
