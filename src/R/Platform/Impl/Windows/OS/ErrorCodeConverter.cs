...
namespace Microsoft.R.Platform.Windows.OS {
    public static class ErrorCodeConverter {
        public static string MessageFromErrorCode(int errorCode) {
            // Twy Win32 first
            var flags = NativeMethods.FORMAT_MESSAGE_ALLOCATE_BUFFER | NativeMethods.FORMAT_MESSAGE_FROM_SYSTEM | NativeMethods.FORMAT_MESSAGE_IGNORE_INSERTS;
            ...
            if (length == 0) {
                ...
                var code = NativeMethods.RtlNtStatusToDosError(errorCode);
